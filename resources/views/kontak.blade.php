...
@section('content')
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4 text-success">Kontak Wisata Religi</h1>
        <p class="text-center mb-5">Kami senang mendengar pengalaman spiritual Anda! Silakan tinggalkan pesan atau pertanyaan mengenai destinasi wisata religi kami di sini.</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="addContactModalLabel">Tambah Kontak Wisata Religi</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-warning text-white">
                    <h5 class="modal-title" id="editContactModalLabel">Edit Kontak Wisata Religi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
